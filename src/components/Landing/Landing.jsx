      ...
      <div className="bg-[#f7d0b6] py-20">
        <div className="max-w-screen-lg mx-auto flex justify-between items-center">
          <div className="max-w-xl">
            ...
            <p className="text-base text-sky-950">Siempre nos destacamos por nuestra excelente atencion y productos</p>
          </div>
        ...
        <div className="grid grid-cols-2 max-w-screen-lg mx-auto">
          ...
          <div className="py-20 bg-slate-100 relative before:absolute before:h-full before:w-screen before:bg-[#23214b] before:top-0 before:left-0">
            <div className="relative z-20 pl-12">
              ...
              <a href="https://wa.me/542604574807" target="_blank" rel="noopener noreferrer"  className="mt-8 text-white uppercase py-3 text-sm px-10 border border-white hover:bg-white hover:bg-opacity-10">Habla con un experto</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 max-w-screen-lg mx-auto">
          <div className="py-20 bg-slate-100 relative before:absolute before:h-full before:w-screen before:bg-[#f7d0b6] before:top-0 before:right-0">
            <div className="relative z-20 pl-12">
              ...
              <p className="text-sky-950 text-sm mb-12">
              ...
              <a href="https://wa.me/542604574807" target="_blank" rel="noopener noreferrer"  className="mt-8 text-black uppercase py-3 text-sm px-10 border border-black hover:bg-black hover:bg-opacity-10">Habla con un experto</a>
            </div>
          </div>
