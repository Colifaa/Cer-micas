    ...
    return (
        <section className="bg-white-300 dark:bg-gray-900">
            <div className="container px-6 py-12 mx-auto">
                <div>
                    <p className="font-medium text-orange-1 dark:text-orange-1">Contacto</p>
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
                    <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                        <div>
                            <span className="inline-block p-3 text-orange-1 rounded-full bg-blue-100/80 dark:bg-gray-800">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-orange-1 dark:text-orange-1">9 de julio y libertad</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-orange-1 dark:text-orange-1">+54 2604 531120</p>
                        </div>
                    </div>
